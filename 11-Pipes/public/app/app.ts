...
import {PorNombrePipe} from 'components/porNombrePipe/porNombrePipe';
...
@View({
	template: `
    <input #filtroNombre (keyup)="null" />
    <div *ngFor="#auto of autos | porNombre: 'marca': filtroNombre.value" [miRealzador]="auto.color" [colorPorDefecto]="auto.colorPorDefectoManzana"
